...
from biogeme.expressions import Beta, DefineVariable,Variable, log,exp,MonteCarlo,bioMax, bioMin, LogLogit
...
mu    = Beta('mu',0.01,0,10,0)

# Utility functions
 
R1 = mu * ( log( 1 + exp( ( B_FSG / mu ) * FSG2_1 ) ) + log( 1 + exp( ( B_FSG / mu ) * FSG3_1 ) ) + log( 1 + exp( ( B_FSG / mu ) * FSG4_1 ) ) + log( 1 + exp( ( B_FSG / mu ) * FSG5_1 ) ) + log( 1 + exp( ( B_FSO / mu ) * FSO2_1 ) ) + log( 1 + exp( ( B_FSO / mu ) * FSO3_1 ) ) + log( 1 + exp( ( B_FSO / mu ) * FSO4_1 ) ) + log( 1 + exp( ( B_FSO / mu ) * FSO5_1 ) ) + log( 1 + exp( ( B_TT / mu ) * TT2_1 ) ) + log( 1 + exp( ( B_TT / mu ) * TT3_1 ) ) + log( 1 + exp( ( B_TT / mu ) * TT4_1 ) ) + log( 1 + exp( ( B_TT / mu ) * TT5_1 ) ))
R2 = mu * ( log( 1 + exp( ( B_FSG / mu ) * FSG1_2 ) ) + log( 1 + exp( ( B_FSG / mu ) * FSG3_2 ) ) + log( 1 + exp( ( B_FSG / mu ) * FSG4_2 ) ) + log( 1 + exp( ( B_FSG / mu ) * FSG5_2 ) ) + log( 1 + exp( ( B_FSO / mu ) * FSO1_2 ) ) + log( 1 + exp( ( B_FSO / mu ) * FSO3_2 ) ) + log( 1 + exp( ( B_FSO / mu ) * FSO4_2 ) ) + log( 1 + exp( ( B_FSO / mu ) * FSO5_2 ) ) + log( 1 + exp( ( B_TT / mu ) * TT1_2 ) ) + log( 1 + exp( ( B_TT / mu ) * TT3_2 ) ) + log( 1 + exp( ( B_TT / mu ) * TT4_2 ) ) + log( 1 + exp( ( B_TT / mu ) * TT5_2 ) ))
R3 = mu * ( log( 1 + exp( ( B_FSG / mu ) * FSG1_3 ) ) + log( 1 + exp( ( B_FSG / mu ) * FSG2_3 ) ) + log( 1 + exp( ( B_FSG / mu ) * FSG4_3 ) ) + log( 1 + exp( ( B_FSG / mu ) * FSG5_3 ) ) + log( 1 + exp( ( B_FSO / mu ) * FSO1_3 ) ) + log( 1 + exp( ( B_FSO / mu ) * FSO2_3 ) ) + log( 1 + exp( ( B_FSO / mu ) * FSO4_3 ) ) + log( 1 + exp( ( B_FSO / mu ) * FSO5_3 ) ) + log( 1 + exp( ( B_TT / mu ) * TT1_3 ) ) + log( 1 + exp( ( B_TT / mu ) * TT2_3 ) ) + log( 1 + exp( ( B_TT / mu ) * TT4_3 ) ) + log( 1 + exp( ( B_TT / mu ) * TT5_3 ) ))
R4 = mu * ( log( 1 + exp( ( B_FSG / mu ) * FSG1_4 ) ) + log( 1 + exp( ( B_FSG / mu ) * FSG2_4 ) ) + log( 1 + exp( ( B_FSG / mu ) * FSG3_4 ) ) + log( 1 + exp( ( B_FSG / mu ) * FSG5_4 ) ) + log( 1 + exp( ( B_FSO / mu ) * FSO1_4 ) ) + log( 1 + exp( ( B_FSO / mu ) * FSO2_4 ) ) + log( 1 + exp( ( B_FSO / mu ) * FSO3_4 ) ) + log( 1 + exp( ( B_FSO / mu ) * FSO5_4 ) ) + log( 1 + exp( ( B_TT / mu ) * TT1_4 ) ) + log( 1 + exp( ( B_TT / mu ) * TT2_4 ) ) + log( 1 + exp( ( B_TT / mu ) * TT3_4 ) ) + log( 1 + exp( ( B_TT / mu ) * TT5_4 ) ))
R5 = mu * ( log( 1 + exp( ( B_FSG / mu ) * FSG1_5 ) ) + log( 1 + exp( ( B_FSG / mu ) * FSG2_5 ) ) + log( 1 + exp( ( B_FSG / mu ) * FSG3_5 ) ) + log( 1 + exp( ( B_FSG / mu ) * FSG4_5 ) ) + log( 1 + exp( ( B_FSO / mu ) * FSO1_5 ) ) + log( 1 + exp( ( B_FSO / mu ) * FSO2_5 ) ) + log( 1 + exp( ( B_FSO / mu ) * FSO3_5 ) ) + log( 1 + exp( ( B_FSO / mu ) * FSO4_5 ) ) + log( 1 + exp( ( B_TT / mu ) * TT1_5 ) ) + log( 1 + exp( ( B_TT / mu ) * TT2_5 ) ) + log( 1 + exp( ( B_TT / mu ) * TT3_5 ) ) + log( 1 + exp( ( B_TT / mu ) * TT4_5 ) ))
