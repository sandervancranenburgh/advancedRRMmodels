##############################################
# file: LC_RUM_PRRM_muRRM_3classes.R
...
apollo_control = list(
  modelName  ="LC_RUM_PRRM_muRRM_3classes",
  modelDescr ="Latent class with 3 classes: RUM, PRRM and muRRM",
  indivID    ="ID",
  nCores     = 2
)
...
apollo_lcPars = function(apollo_beta, apollo_inputs){
  lcpars = list()
  lcpars[["B_FSG"]] = list(B_FSG_1, B_FSG_2, B_FSG_3)
  lcpars[["B_FSO"]] = list(B_FSO_1, B_FSO_2, B_FSO_3)
  lcpars[["B_TT"]]  = list(B_TT_1, B_TT_2, B_TT_3)
  
  ###Class membership probabilities based on s_1, s_2, s_3: use of MNL fomula
  V=list()
  V[["class_1"]] = s_1
  V[["class_2"]] = s_2
  V[["class_3"]] = s_3
...
apollo_probabilities=function(apollo_beta, apollo_inputs, functionality="estimate"){
  ...
  ### Compute class-specific utilities for Class 1
  V=list()
  ...
  ### Calculating MNL probabilities for Class 2
  ...
  ### Compute class-specific regrets for Class 3
  R=list()
  R[['Alt1']]  =      mu_3 * (log( 1 + exp( ( B_FSG_3 / mu_3 ) * FSG2_1 ) ) + 
                              log( 1 + exp( ( B_FSG_3 / mu_3 ) * FSG3_1 ) ) + 
                              log( 1 + exp( ( B_FSG_3 / mu_3 ) * FSG4_1 ) ) + 
                              log( 1 + exp( ( B_FSG_3 / mu_3 ) * FSG5_1 ) ) + 
                              log( 1 + exp( ( B_FSO_3 / mu_3 ) * FSO2_1 ) ) + 
                              log( 1 + exp( ( B_FSO_3 / mu_3 ) * FSO3_1 ) ) + 
                              log( 1 + exp( ( B_FSO_3 / mu_3 ) * FSO4_1 ) ) + 
                              log( 1 + exp( ( B_FSO_3 / mu_3 ) * FSO5_1 ) ) +
                              log( 1 + exp( ( B_TT_3  / mu_3 ) * TT2_1  ) ) + 
                              log( 1 + exp( ( B_TT_3  / mu_3 ) * TT3_1  ) ) + 
                              log( 1 + exp( ( B_TT_3  / mu_3 ) * TT4_1  ) ) + 
                              log( 1 + exp( ( B_TT_3  / mu_3 ) * TT5_1  ) ))
  R[['Alt2']]  =      mu_3 * (log( 1 + exp( ( B_FSG_3 / mu_3 ) * FSG1_2 ) ) + 
                              log( 1 + exp( ( B_FSG_3 / mu_3 ) * FSG3_2 ) ) +
                              log( 1 + exp( ( B_FSG_3 / mu_3 ) * FSG4_2 ) ) + 
                              log( 1 + exp( ( B_FSG_3 / mu_3 ) * FSG5_2 ) ) + 
                              log( 1 + exp( ( B_FSO_3 / mu_3 ) * FSO1_2 ) ) + 
                              log( 1 + exp( ( B_FSO_3 / mu_3 ) * FSO3_2 ) ) + 
                              log( 1 + exp( ( B_FSO_3 / mu_3 ) * FSO4_2 ) ) + 
                              log( 1 + exp( ( B_FSO_3 / mu_3 ) * FSO5_2 ) ) + 
                              log( 1 + exp( ( B_TT_3  / mu_3 ) * TT1_2  ) ) + 
                              log( 1 + exp( ( B_TT_3  / mu_3 ) * TT3_2  ) ) + 
                              log( 1 + exp( ( B_TT_3  / mu_3 ) * TT4_2  ) ) + 
                              log( 1 + exp( ( B_TT_3  / mu_3 ) * TT5_2  ) ))
  R[['Alt3']]  =      mu_3 * (log( 1 + exp( ( B_FSG_3 / mu_3 ) * FSG1_3 ) ) + 
                              log( 1 + exp( ( B_FSG_3 / mu_3 ) * FSG2_3 ) ) + 
                              log( 1 + exp( ( B_FSG_3 / mu_3 ) * FSG4_3 ) ) + 
                              log( 1 + exp( ( B_FSG_3 / mu_3 ) * FSG5_3 ) ) + 
                              log( 1 + exp( ( B_FSO_3 / mu_3 ) * FSO1_3 ) ) + 
                              log( 1 + exp( ( B_FSO_3 / mu_3 ) * FSO2_3 ) ) + 
                              log( 1 + exp( ( B_FSO_3 / mu_3 ) * FSO4_3 ) ) + 
                              log( 1 + exp( ( B_FSO_3 / mu_3 ) * FSO5_3 ) ) + 
                              log( 1 + exp( ( B_TT_3  / mu_3 ) * TT1_3  ) ) + 
                              log( 1 + exp( ( B_TT_3  / mu_3 ) * TT2_3  ) ) + 
                              log( 1 + exp( ( B_TT_3  / mu_3 ) * TT4_3  ) ) + 
                              log( 1 + exp( ( B_TT_3  / mu_3 ) * TT5_3  ) ))
  R[['Alt4']]  =      mu_3 * (log( 1 + exp( ( B_FSG_3 / mu_3 ) * FSG1_4 ) ) + 
                              log( 1 + exp( ( B_FSG_3 / mu_3 ) * FSG2_4 ) ) + 
                              log( 1 + exp( ( B_FSG_3 / mu_3 ) * FSG3_4 ) ) + 
                              log( 1 + exp( ( B_FSG_3 / mu_3 ) * FSG5_4 ) ) + 
                              log( 1 + exp( ( B_FSO_3 / mu_3 ) * FSO1_4 ) ) + 
                              log( 1 + exp( ( B_FSO_3 / mu_3 ) * FSO2_4 ) ) + 
                              log( 1 + exp( ( B_FSO_3 / mu_3 ) * FSO3_4 ) ) + 
                              log( 1 + exp( ( B_FSO_3 / mu_3 ) * FSO5_4 ) ) + 
                              log( 1 + exp( ( B_TT_3  / mu_3 ) * TT1_4  ) ) + 
                              log( 1 + exp( ( B_TT_3  / mu_3 ) * TT2_4  ) ) + 
                              log( 1 + exp( ( B_TT_3  / mu_3 ) * TT3_4  ) ) + 
                              log( 1 + exp( ( B_TT_3  / mu_3 ) * TT5_4  ) ))
  R[['Alt5']]  =      mu_3 * (log( 1 + exp( ( B_FSG_3 / mu_3 ) * FSG1_5 ) ) + 
                              log( 1 + exp( ( B_FSG_3 / mu_3 ) * FSG2_5 ) ) + 
                              log( 1 + exp( ( B_FSG_3 / mu_3 ) * FSG3_5 ) ) + 
                              log( 1 + exp( ( B_FSG_3 / mu_3 ) * FSG4_5 ) ) + 
                              log( 1 + exp( ( B_FSO_3 / mu_3 ) * FSO1_5 ) ) + 
                              log( 1 + exp( ( B_FSO_3 / mu_3 ) * FSO2_5 ) ) + 
                              log( 1 + exp( ( B_FSO_3 / mu_3 ) * FSO3_5 ) ) + 
                              log( 1 + exp( ( B_FSO_3 / mu_3 ) * FSO4_5 ) ) + 
                              log( 1 + exp( (  B_TT_3 / mu_3 ) * TT1_5  ) ) + 
                              log( 1 + exp( (  B_TT_3 / mu_3 ) * TT2_5  ) ) + 
                              log( 1 + exp( (  B_TT_3 / mu_3 ) * TT3_5  ) ) + 
                              log( 1 + exp( (  B_TT_3 / mu_3 ) * TT4_5  ) )   )  
  
  mnl_settings$V = lapply(R, "*", -1) ###the regrets must be negative (and used in MNL-settings as V)
  
  ### Calculating MNL probabilities for Class 3
  P[[3]] = apollo_mnl(mnl_settings, functionality)
  P[[3]] = apollo_panelProd(P[[3]], apollo_inputs ,functionality)
...
apollo_beta = apollo_searchStart(apollo_beta,
                                ...
                                apollo_inputs,
                                searchStart_settings=list(nCandidates=25))
