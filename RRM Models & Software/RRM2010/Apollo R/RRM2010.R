...
apollo_probabilities=function(apollo_beta, apollo_inputs, functionality="estimate"){
  ...
  R = list()
  R[['Alt1']]  = - log( 1 + exp( B_FSG * FSG2_1 ) ) - log( 1 + exp( B_FSG * FSG3_1 ) ) - log( 1 + exp( B_FSG * FSG4_1 ) ) - log( 1 + exp( B_FSG * FSG5_1 ) )- log( 1 + exp( B_FSO * FSO2_1 ) ) - log( 1 + exp( B_FSO * FSO3_1 ) ) - log( 1 + exp( B_FSO * FSO4_1 ) ) - log( 1 + exp( B_FSO * FSO5_1 ) )- log( 1 + exp( B_TT * TT2_1 ) ) - log( 1 + exp( B_TT * TT3_1 ) ) - log( 1 + exp( B_TT * TT4_1 ) ) - log( 1 + exp( B_TT * TT5_1 ) )
  R[['Alt2']]  = - log( 1 + exp( B_FSG * FSG1_2 ) ) - log( 1 + exp( B_FSG * FSG3_2 ) ) - log( 1 + exp( B_FSG * FSG4_2 ) ) - log( 1 + exp( B_FSG * FSG5_2 ) )- log( 1 + exp( B_FSO * FSO1_2 ) ) - log( 1 + exp( B_FSO * FSO3_2 ) ) - log( 1 + exp( B_FSO * FSO4_2 ) ) - log( 1 + exp( B_FSO * FSO5_2 ) )- log( 1 + exp( B_TT * TT1_2 ) ) - log( 1 + exp( B_TT * TT3_2 ) ) - log( 1 + exp( B_TT * TT4_2 ) ) - log( 1 + exp( B_TT * TT5_2 ) )
  R[['Alt3']]  = - log( 1 + exp( B_FSG * FSG1_3 ) ) - log( 1 + exp( B_FSG * FSG2_3 ) ) - log( 1 + exp( B_FSG * FSG4_3 ) ) - log( 1 + exp( B_FSG * FSG5_3 ) )- log( 1 + exp( B_FSO * FSO1_3 ) ) - log( 1 + exp( B_FSO * FSO2_3 ) ) - log( 1 + exp( B_FSO * FSO4_3 ) ) - log( 1 + exp( B_FSO * FSO5_3 ) )- log( 1 + exp( B_TT * TT1_3 ) ) - log( 1 + exp( B_TT * TT2_3 ) ) - log( 1 + exp( B_TT * TT4_3 ) ) - log( 1 + exp( B_TT * TT5_3 ) )
  R[['Alt4']]  = - log( 1 + exp( B_FSG * FSG1_4 ) ) - log( 1 + exp( B_FSG * FSG2_4 ) ) - log( 1 + exp( B_FSG * FSG3_4 ) ) - log( 1 + exp( B_FSG * FSG5_4 ) )- log( 1 + exp( B_FSO * FSO1_4 ) ) - log( 1 + exp( B_FSO * FSO2_4 ) ) - log( 1 + exp( B_FSO * FSO3_4 ) ) - log( 1 + exp( B_FSO * FSO5_4 ) )- log( 1 + exp( B_TT * TT1_4 ) ) - log( 1 + exp( B_TT * TT2_4 ) ) - log( 1 + exp( B_TT * TT3_4 ) ) - log( 1 + exp( B_TT * TT5_4 ) )
  R[['Alt5']]  = - log( 1 + exp( B_FSG * FSG1_5 ) ) - log( 1 + exp( B_FSG * FSG2_5 ) ) - log( 1 + exp( B_FSG * FSG3_5 ) ) - log( 1 + exp( B_FSG * FSG4_5 ) )- log( 1 + exp( B_FSO * FSO1_5 ) ) - log( 1 + exp( B_FSO * FSO2_5 ) ) - log( 1 + exp( B_FSO * FSO3_5 ) ) - log( 1 + exp( B_FSO * FSO4_5 ) )- log( 1 + exp( B_TT * TT1_5 ) ) - log( 1 + exp( B_TT * TT2_5 ) ) - log( 1 + exp( B_TT * TT3_5 ) ) - log( 1 + exp( B_TT * TT4_5 ) )
